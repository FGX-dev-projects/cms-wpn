...
class MemberCrudRequest extends FormRequest
{
    /**a
    ...
    public function rules()
    {
        return [
            ...
            'core_focus' => 'nullable|string|max:1000',
            ...
            //'member_group_id' => 'required|integer|exists:member_groups,id', // Ensure the foreign key exists in `member_groups` table
