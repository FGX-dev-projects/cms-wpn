     ...
     public function index(Request $request)
{
    ...
    return view('members.index', compact('data', 'memberGroups'));
}
    ...
    public function create()
    {
        ...
        return view('members.create', compact( 'data', 'memberGroups'));
    }
    ...
    public function edit($id)
    {
        ...
        //dd($data);
        return view('members.edit',compact('data','memberGroups' ));
    }
...
//                 // Send invoice email using the InvoiceMail Mailable
//                 Mail::to($member->invoice_email)->send(new InvoiceMail($member));
