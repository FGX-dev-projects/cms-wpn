...
class KznController extends Controller
{
    public function index(Request $request)
{
    ...
    return view('kzn.index', compact('data', 'memberGroups'));
}
    ...
    public function create()
    {
        ...
        return view('kzn.create', compact( 'data', 'memberGroups'));
    }
    ...
    $capetown->save();
        ...
        return redirect(route('kzn.index'));
    }

    public function edit($id)
    {
        $data = Kznuni::findOrFail($id);
        $memberGroups = MemberGroup::all();
        
      

        //dd($data);
        return view('kzn.edit',compact('data','memberGroups' ));
    }
    ...
    public function sendInvoices(Request $request)
{
    ...
    $validated = $request->validate([
        ...
        'selected_members.*' => 'exists:kznunis,id',
    ]);

    $members = Kznuni::whereIn('id', $validated['selected_members'])->get();
        ...
        if ($member->email) {
            try {
                ...
                if (!$member->invoice_number) {
                    ...
                    $latestInvoice = Kznuni::where('invoice_number', 'LIKE', "{$yearMonth}-%")
