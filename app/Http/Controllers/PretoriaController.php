...
class PretoriaController extends Controller
{
     public function index(Request $request)
{
    $query = Pretoria::query();
    ...
    return view('pretoria.index', compact('data', 'memberGroups'));
}
    ...
    public function create()
    {
        ...
        return view('pretoria.create', compact( 'data', 'memberGroups'));
    }
    ...
    $capetown->save();
        ...
        return redirect(route('pretoria.index'));
    }

    public function edit($id)
    {
        $data = Pretoria::findOrFail($id);
        $memberGroups = MemberGroup::all();
        
      

        //dd($data);
        return view('pretoria.edit',compact('data','memberGroups','selectedGroupIds' ));
    }
    ...
    public function sendInvoices(Request $request)
{
    ...
    $validated = $request->validate([
        ...
        'selected_members.*' => 'exists:pretorias,id',
    ]);

    $members = Pretoria::whereIn('id', $validated['selected_members'])->get();
        ...
        if ($member->email) {
            try {
                ...
                if (!$member->invoice_number) {
                    ...
                    $latestInvoice = Pretoria::where('invoice_number', 'LIKE', "{$yearMonth}-%")
