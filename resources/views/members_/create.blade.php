    ...
    <div class="container-fluid">
        ...
        <div class="card rounded-12 shadow-dark-80 border border-gray-50 mb-3 mb-xl-5">
            ...
            <div class="card-body px-0 p-md-4">
                <form class="px-3 form-style-two" action="{{ route('members.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-md-4 pb-3">
                            ...
                            <input type="text" class="form-control form-control-xl" id="name" name="name" placeholder="Name" value="{{ old('name') }}">
                        </div>
                        <div class="col-sm-12 mb-md-4 pb-3">
                            <label for="Title" class="form-label form-label-lg">Title</label>
                            <input type="text" class="form-control form-control-xl" id="title" name="title" placeholder="Title" value="{{ old('title') }}">
                        </div>
                        <div class="col-sm-12 mb-md-4 pb-3">
