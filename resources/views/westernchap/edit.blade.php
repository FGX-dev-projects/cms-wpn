            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card innercard">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('westernchap.index') }}" class="new-artictle-btn"  >
                    ...
                    <div class="card-body py-4">
                        <form class="px-3 form-style-two" action="{{ route('westernchap.update', $data->id) }}" method="post"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="paid" value="0" value="0" {{ old('paid', $data->paid) == 0 ? 'checked' : '' }}>
