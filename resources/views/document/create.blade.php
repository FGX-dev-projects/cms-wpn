...
@section('breadcrumb', 'Create Article Resource')
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card innercard">
                    ...
                    <div class="card-header border-0 pt-6">
                        <!--begin::Card title-->
                        <h2 class="part-Title">New Resource</h2>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="title" required id="title" class="form-control form-control-solid mb-3 mb-lg-0 @error('title') is-invalid @enderror" placeholder="" value="{{ old('title') }}" />
                            @error('title')
                         ...
                         <!--div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7">
                                <label for="pdf" class="required fs-6 mb-2">Upload PDF </label>
                                <!--input type="file" name="pdf" id="pdf_path" accept=".pdf" required-->

                                <div class="custom-file-input2">
                                    <input type="file" name="pdf" id="pdf" class="form-control form-control-solid @error('pdf') is-invalid @enderror">
                                    <img src="{{ asset('/assets/images/upload-file.svg') }}" alt="Add Image">
                                    <button class="add-image-btn2  pdf" type="button">Add PDF</button>
                                </div>
                                @error('pdf')
                                    <div class="invalid-feedback"> {{ $message }}</div>
                                @enderror
