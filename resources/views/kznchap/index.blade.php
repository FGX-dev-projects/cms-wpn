...
@section('content')
            ...
            <div class="row">
                <div class="frame-parent2">
                   ...
                   <img class="icons" alt="" src="{{ asset('/assets/images/icons.png') }}">
                    <b class="dashboard">Manage Members | KZN Chapter</b>
                    </div>
                    </div>
                     <div style="display:flex; justify-content: end" class="my-10 mb-10">
                        <form method="GET" action="{{ route('kznchap.index') }}" class="d-flex mt-4 mb-4">
                ...
                <div class="card art-body" style="border: none !important;">
                    <form   method="POST" action="{{ route('kznchap.send-invoices') }}">
                        @csrf
                    <div style="border: none !important; padding-left:15px;" class="card-header pt-6 ">
                       ...
                       <div class="card-title gap-4">
                            ...
                            <div class="mt-4 text-end ">
                                <a href="{{ route('export.table', ['table' => 'kzn_chapters']) }}" class="new-part-btn">Export Members</a>
                            </div>
                        </div>
                        
                        <div style="justify-content: end !important;" class="card-toolbar  ">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="new-part-btn" onclick="location.href='{{ route('kznchap.create') }}'">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="actions-popup" id="actions-popup-{{ $x->id }}">
                                                        <div class="menu-item">
                                                            <a class="dd" href="{{ route('kznchap.edit', $x->id) }}">Edit Member</a>
                                                        </div>
                                                    </form>
                                                        <div class="menu-item">
                                                            <form action="{{ route('kznchap.destroy', $x->id) }}" method="POST" id="delete-form-{{ $x->id }}">
                                                                {{ method_field('DELETE') }}
                                                                @csrf
