                    ...
                    <div class="card-body py-4">
                        <form class="px-3 form-style-two" action="{{ route('posts.update', $data->id) }}" method="post"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input class="form-control form-control-solid @error('article_date') is-invalid @enderror" name="article_date" placeholder="Pick a date" id="kt_datepicker_2" value="{{ $data->article_date }}"/>
                                @error('article_date')
                                <div class="invalid-feedback"> {{ $message }}</div>
                                @enderror
                            </div>
