@section('title', 'Member applicationt')
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card innercard">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('capetown.index') }}" class="new-artictle-btn"  >
                    ...
                    <div class="card-body py-4">
                        <form class="px-3 form-style-two" action="{{ route('capetown.update', $data->id) }}" method="post"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="year_of_study" class="form-control form-control-solid @error('year_of_study') is-invalid @enderror" value="{{  $data->year_of_study }}">
                            @error('year_of_study')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
