                    ...
                    <div class="card-body py-4">
                        <form action="{{ route('billing.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="company_information" id="company_information" class="form-control form-control-solid @error('company_information') is-invalid @enderror">{{ old('company_information') }}</textarea>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="bank_details" id="bank_details" class="form-control form-control-solid @error('bank_details') is-invalid @enderror">{{ old('bank_details') }}</textarea>
                                @error('bank_details')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="email" name="email" id="email" class="form-control form-control-solid @error('email') is-invalid @enderror" value="{{ old('email') }}" />
                                @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="tax" id="tax" class="form-control form-control-solid @error('tax') is-invalid @enderror" value="{{ old('tax') }}" />
                                @error('tax')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="year" id="year" class="form-control form-control-solid @error('year') is-invalid @enderror" value="{{ old('year') }}" />
                                @error('year')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
