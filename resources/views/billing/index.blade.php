...
@section('content')
            ...
            <div class="row">
                <div class="frame-parent2">
                   ...
                   <img class="icons" alt="" src="{{ asset('/assets/images/icons.png') }}">
                    <b class="dashboard">Manage Billing</b>
                    </div>
                    </div>
                    ...
                    <div style="border: none !important; padding-left:15px;" class="card-header pt-6 justify-content-end">
                        ...
                        <div style="justify-content: end !important;" class="card-toolbar  ">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="new-part-btn" onclick="location.href='{{ route('billing.create') }}'">
                    ...
                    <div class="card-body art-body">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 custom-table"  id="kt_table_users">
                            ...
                            <tr class="text-start  fw-bold fs-7 text-uppercase gs-0">
                                <th class="min-w-125px act">Company</th>
                                <th class="min-w-125px act">Last Updated</th>
                                ...
                                <tr>
                                    <td class="d-flex align-items-center ">
                                        ...
                                        <div class="d-flex flex-column data-title">
                                            <span>{{ substr($x->company_information, 0, 38) }}...</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="actions-popup" id="actions-popup-{{ $x->id }}">
                                            <div class="menu-item">
                                                <a class="dd" href="{{ route('billing.edit', $x->id) }}"><img src="{{ asset('/assets/images/Shape.png') }}" />  Edit </a>
                                            </div>
                                            <div class="menu-item">
                                                <form action="{{ route('billing.destroy', $x->id) }}" method="POST" id="delete-form-{{ $x->id }}">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
