...
@section('breadcrumb', 'Manage Videos')
...
@section('content')
    ...
    <div class="row">
        <div class="frame-parent2">
           ...
           <img class="icons" alt="" src="{{ asset('/assets/images/icons.png') }}">
            <b class="dashboard">Manage Videos</b>
            </div>
            </div>
        <!--begin::Content-->
        <div >
                            ...
                            @else
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="actions-popup" id="actions-popup-{{ $x->id }}">
                                            <div class="menu-item">
                                                <a class="dd" href="{{ route('videos.edit', $x->id) }}"> <img src="{{ asset('/assets/images/Shape.png') }}" /> Edit Video</a>
                                            </div>
                                            <div class="menu-item">
                                                <form action="{{ route('videos.destroy', $x->id) }}" method="POST" id="delete-form-{{ $x->id }}">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="mx-xl-15 part-Title">New Video</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
    ...
    <script>
        function updateVideoPreview() {
            ...
            if (videoId) {
                ...
                iframe.style.display = 'none'; // Hide the iframe if URL is invalid
            }
        }
